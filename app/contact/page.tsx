      ...
      <div className="container">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-heading font-bold mb-6 text-green-800">
                Get in Touch
              </h2>
              <div className="space-y-6">
                {[
                    ...
                    content: (
                      <div className="space-y-1">
                        <a
                          ...
                          className="text-gray-600 hover:text-green-600 block transition-colors duration-300"
                        >
                          +88 01716 633445
                        </a>
                        <a
                    ...
                    content: (
                      <>
                        ...
                        <p className="text-sm text-gray-500 mt-2">
                          ~20 minutes from Hazrat Shahjalal International
                          Airport
                        </p>
                      </>
                    ),
                  ...
                  <div key={title} className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl icon-glow flex items-center justify-center shrink-0">
            ...
            {/* Map — Glass Frame */}
            <div className="rounded-xl overflow-hidden h-64 glass p-1">
              <iframe
